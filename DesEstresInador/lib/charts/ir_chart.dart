...
class IrChart extends StatefulWidget {
  final MqttServerClient client;
  final String topic;

  const IrChart({super.key, required this.client, required this.topic});

  @override
  _IrChartState createState() => _IrChartState();
}

class _IrChartState extends State<IrChart> {
  List<FlSpot> _spots = [];
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Señal MAX30102', // Título para la gráfica
              style: TextStyle(
                fontSize: 24,
