...
class TemperatureAmbientChart extends StatefulWidget {
  final MqttServerClient client;
  final String topic;

  const TemperatureAmbientChart({super.key, required this.client, required this.topic});

  @override
  _TemperatureAmbientChartState createState() => _TemperatureAmbientChartState();
}

class _TemperatureAmbientChartState extends State<TemperatureAmbientChart> {
