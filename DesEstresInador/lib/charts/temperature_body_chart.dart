...
class TemperatureBodyChart extends StatefulWidget {
  final MqttServerClient client;
  final String topic;

  const TemperatureBodyChart({super.key, required this.client, required this.topic});

  @override
  _TemperatureBodyChartState createState() => _TemperatureBodyChartState();
}

class _TemperatureBodyChartState extends State<TemperatureBodyChart> {
